...
PYBIND11_MODULE(pywrap_quantize_model, m) {
  ...
  m.def(
      ...
      [](std::string saved_model_path, std::string exported_names_str,
         std::string tags) {
        return tensorflow::PyoOrThrow(tensorflow::QuantizeQATModel(
  ...
  m.def(
      ...
      [](std::string saved_model_path, std::string exported_names_str,
        ...
        return tensorflow::PyoOrThrow(
            tensorflow::QuantizePTQModelPreCalibration(
                saved_model_path, exported_names_str, tags));
      },
      R"pbdoc(
      Returns a tf model graph def string.
  ...
  m.def(
      ...
      [](std::string saved_model_path, std::string exported_names_str,
         std::string tags) {
        return tensorflow::PyoOrThrow(
            tensorflow::QuantizePTQModelPostCalibration(
                saved_model_path, exported_names_str, tags));
      },
      R"pbdoc(
      Returns a tf model graph def string.
